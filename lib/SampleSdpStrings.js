...
exports.simulcastSdp = transform.parse(simulcastSdpStr);
exports.simulcastRtxSdp = transform.parse(simulcastRtxSdpStr);
exports.plainVideoSdp = transform.parse(plainVideoSdpStr);
exports.rtxVideoSdp = transform.parse(rtxVideoSdpStr);
