        ...
        if (typeof sources === 'object') {
            ...
            Object.keys(sources).forEach(function(ssrc) {
                ...
                if (typeof mLine === 'object') {
                    ...
                    // Use the "bLine" as a prototype for the "mLine".
                    mLine = Object.create(bLine);
                    ssrc2ml[ssrc] = mLine;
                    ...
                    if (typeof mLine.mid === 'undefined') {
                        ...
                        mLine.mid = [bLine.type, '-', ssrc].join('');
                    }
    ...
    if (desc.type === 'answer') {
        ...
        cachedOffer.media.forEach(function(mo) {
            ...
            cached.media.some(function(ma) {
                if (mo.mid == ma.mid) {
                    if (typeof mid2ul[mo.mid] === 'undefined') {
        ...
        if (typeof cached !== 'undefined' &&
            ...
            cached.media.forEach(function(pm) {
                mids.push(pm.mid);
                if (typeof mid2ul[pm.mid] !== 'undefined') {
                    session.media.push(mid2ul[pm.mid]);
                } else {
                    delete pm.msid;
                    delete pm.sources;
